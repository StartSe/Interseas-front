...
export declare const defaultChecklist: string;
export declare const conferencesDefault: string;
export declare const checklistCeMercante =
...
export declare const checklistCertificadoOrigem =
...
export declare const checklistCommercialInvoice: string;
export declare const checklistConhecimentoBL: string;
export declare const checklistConhecimentoHawb: string;
export declare const checklistConhecimentoMawb =
...
export declare const checklistCRT =
...
export declare const checklistPackingList =
...
export declare const ChecklistProformaInvoice =
...
export declare const checklistLabels =
...
export declare const checklistAnaliseDeVinhos =
...
export declare const checklistRotulosEContrarrotulosVinhos =
  '\n\u2022 Denomina\u00E7\u00E3o - (VINHO TIPO + COR + A\u00C7\u00DACAR, nesta ordem, exceto para VINHO MOSCATO ESPUMANTE ou VINHO MOSCATEL ESPUMANTE)\n\u2022 Produzido e engarrafado por - (NOME, ENDERE\u00C7O, REGISTRO JUNTO AO MAPA, se houver)\n\u2022 Dados do Exportador - (opcional) (NOME / ENDERE\u00C7O / REGISTRO JUNTO AO MAPA, se houver)\n\u2022 Dados do Importador - (NOME / ENDERE\u00C7O COMPLETO / CNPJ / Registro no MAPA)\n\u2022 Distribuidor - (opcional) (NOME / ENDERE\u00C7O COMPLETO / CNPJ / Registro no MAPA)\n\u2022 Ingredientes e aditivos alimentares - (Exemplo: \u201CIngredientes: elaborado com uvas vin\u00EDferas, conservador anidrido sulfuroso (INS 220)\u201D)\n\u2022 Prazo de validade e conserva\u00E7\u00E3o do produto - (Exemplo: \u201CPrazo de validade indeterminado desde que conservado em local seco e ao abrigo da luz, preferencialmente na posi\u00E7\u00E3o horizontal\u201D)\n\u2022 Conte\u00FAdo l\u00EDquido - (A indica\u00E7\u00E3o quantitativa pode ser precedida das declara\u00E7\u00F5es \u201CPeso l\u00EDquido\u201D ou \u201CConte\u00FAdo l\u00EDquido\u201D)\n\u2022 Gradua\u00E7\u00E3o alco\u00F3lica - (Exemplo: \u201C13,5% Vol.\u201D)\n\u2022 Safra - (opcional) (Permitida a indica\u00E7\u00E3o da safra para vinhos feitos com uvas de 85% da safra indicada)\n\u2022 Pa\u00EDs de origem - (Informar o pa\u00EDs de origem)\n\u2022 EVITE O CONSUMO EXCESSIVO DE \u00C1LCOOL\n\u2022 \u201CN\u00C3O CONT\u00C9M GL\u00DATEN\u201D\n\u2022 \u201CPROIBIDA A VENDA PARA MENORES DE 18 ANOS\u201D\n\u2022 Lote - (Exemplo: \u201CLote: XXXXX. Lote: vide garrafa\u201D)\n\u2022 Marca - (Incluir a marca do produto)\n\u2022 S\u00EDmbolo de Gr\u00E1vida com o \u201Cr\u201D de proibido\n\u2022 S\u00EDmbolo de retorno/recicl\u00E1vel';
export declare const checklistOrdemDeCompra =
...
export declare const checklistInstrucaoDeEmbarque =
...
export declare const checklistCertificadoDeAnalise =
...
export declare const checklistCertificadoFitossanitario =
  '\n\u2022 N\u00FAmero\n\u2022 Dados do Exportador - (Raz\u00E3o social, endere\u00E7o e CNPJ)\n\u2022 Dados do Consignat\u00E1rio/Importador - (Raz\u00E3o social, endere\u00E7o e CNPJ)\n\u2022 "To Plant Protection Organization of" - (Pa\u00EDs de destino)\n\u2022 Local de origem\n\u2022 Descri\u00E7\u00E3o das mercadorias\n\u2022 Quantidade\n\u2022 Tratamento\n\u2022 Dura\u00E7\u00E3o e temperatura\n\u2022 Data\n\u2022 Assinatura';
export declare const checklistAnexoVII =
...
export declare const checklistFichaDeEmergencia =
  '\n\u2022 Emissor do documento (Adquirente/Notify)\n\u2022 Descri\u00E7\u00E3o das mercadorias\n\u2022 Carga perigosa - C\u00F3digo Indicador (UN)\n\u2022 Carga perigosa - Classe\n\u2022 Carga perigosa - Package group';
export declare const checklistMSDS =
  '\n\u2022 Emissor do documento (Adquirente/Notify)\n\u2022 Descri\u00E7\u00E3o das mercadorias\n\u2022 Carga perigosa - C\u00F3digo Indicador (UN)\n\u2022 Carga perigosa - Classe\n\u2022 Carga perigosa - Package group';
export declare const checklistCotacaoDeFrete =
...
export declare const checklistTypeMapping: {
  'PROFORMA INVOICE': string;
  'COMMERCIAL INVOICE': string;
  'PACKING LIST': string;
  'CONHECIMENTO - B/L': string;
  HAWB: string;
  'CONHECIMENTO - MAWB': string;
  'CONHECIMENTO - CRT': string;
  'CE MERCANTE': string;
  'CERTIFICADO DE ORIGEM': string;
  'DOWNPAYMENT INVOICE': string;
  'CCT A\u00C9REO': string;
  'CONHECIMENTO - MIC/DTA': string;
  LABEL: string;
  'CERTIFICADO DE AN\u00C1LISE DE VINHOS': string;
  'ORDEM DE COMPRA DO IMPORTADOR': string;
  'INSTRU\u00C7\u00C3O DE EMBARQUE': string;
  'TEST REPORT': string;
  'CERTIFICADO FITOSSANIT\u00C1RIO': string;
  'DECLARA\u00C7\u00C3O DE CARGA PERIGOSA': string;
  'FICHA DE EMERG\u00CANCIA': string;
  'MSDS/FISPQ': string;
  'COTA\u00C7\u00C3O DE FRETE': string;
};
export declare const documentPriorityMapping: {
  [x: string]: number;
};
export declare const sortUploadFiles: (uploadFiles: FileMapping[]) => FileMapping[];
export declare const identifyDocumentChecklist: (documentType: keyof typeof DocumentTypes) => string | null;
export declare const identifyDocumentType: (
  fileName: string,
) =>
  | 'DUIMP'
  | 'PROPOSTA'
  | 'PROFORMA_INVOICE'
  | 'COMMERCIAL_INVOICE'
  | 'DOCUMENTO_SEM_CHECKLIST'
  | 'PACKING_LIST'
  | 'CONHECIMENTO_BL'
  | 'CONHECIMENTO_HAWB'
  | 'CONHECIMENTO_MAWB'
  | 'CONHECIMENTO_CRT'
  | 'CONHECIMENTO_MIC_DTA'
  | 'CE_MERCANTE'
  | 'CCT'
  | 'INSTRUCAO_DE_EMBARQUE'
  | 'DUE'
  | 'DECLARACAO_DE_IMPORTACAO'
  | 'RESUMO_DA_DECLARACAO_DE_IMPORTACAO'
  | 'LICENCA_DE_IMPORTACAO'
  | 'LPCO'
  | 'DOWNPAYMENT_INVOICE'
  | 'ORDEM_DE_COMPRA_DO_IMPORTADOR'
  | 'SALES_ORDER_DOCUMENT'
  | 'CONFIRMATION_OF_ORDER'
  | 'CERTIFICADO_DE_ORIGEM_DIGITAL'
  | 'CERTIFICADO_DE_ORIGEM'
  | 'TEST_REPORT'
  | 'LABELS'
  | 'ANEXO_IX'
  | 'ANEXO_XI'
  | 'CERTIFICADO_DE_INSPECAO'
  | 'CERTIFICADO_DE_CONFORMIDADE_ORGANICA'
  | 'DECLARACAO_DE_TRANSACAO_COMERCIAL'
  | 'ATESTADO_DE_INEXISTENCIA_DE_PRODUCAO_ESTADUAL'
  | 'CATALOGO_DE_EQUIPAMENTO'
  | 'CERTIFICADO_DE_COMPLIANCE'
  | 'CERTIFICADO_DE_ESTERILIZACAO'
  | 'DECLARACAO_DO_DETENTOR_DA_REGULARIZACAO'
  | 'MSDS'
  | 'FICHA_DE_EMERGENCIA'
  | 'SHIPPERS_DECLARATION'
  | 'ANEXO_VII'
  | 'FICHA_DE_LOTE'
  | 'CERTIFICADO_FITOSSANITARIO'
  | 'CERTIFICADO_DE_ANALISE_DE_VINHOS'
  | 'COTACAO_DE_FRETE'
  | null;
export declare const removeAccents: (text: string) => string;
//# sourceMappingURL=fileClassificationUtils.d.ts.map
