...
export declare const identifyDocumentType: (fileName: string) => "CCT" | "DUIMP" | "PROPOSTA" | "MSDS" | "FISPQ" | "PROFORMA_INVOICE" | "COMMERCIAL_INVOICE" | "PACKING_LIST" | "CONHECIMENTO_BL" | "CONHECIMENTO_HAWB" | "CONHECIMENTO_MAWB" | "CONHECIMENTO_CRT" | "CONHECIMENTO_MIC_DTA" | "CE_MERCANTE" | "INSTRUCAO_DE_EMBARQUE" | "DUE" | "DECLARACAO_DE_IMPORTACAO" | "RESUMO_DA_DECLARACAO_DE_IMPORTACAO" | "LICENCA_DE_IMPORTACAO" | "LPCO" | "DOWNPAYMENT_INVOICE" | "ORDEM_DE_COMPRA_DO_IMPORTADOR" | "SALES_ORDER_DOCUMENT" | "CONFIRMATION_OF_ORDER" | "CERTIFICADO_DE_ORIGEM_DIGITAL" | "CERTIFICADO_DE_ORIGEM" | "TEST_REPORT" | "LABELS" | "ANEXO_IX" | "ANEXO_XI" | "CERTIFICADO_DE_INSPECAO" | "CERTIFICADO_DE_CONFORMIDADE_ORGANICA" | "DECLARACAO_DE_TRANSACAO_COMERCIAL" | "ATESTADO_DE_INEXISTENCIA_DE_PRODUCAO_ESTADUAL" | "CATALOGO_DE_EQUIPAMENTO" | "CERTIFICADO_DE_COMPLIANCE" | "CERTIFICADO_DE_ESTERILIZACAO" | "DECLARACAO_DO_DETENTOR_DA_REGULARIZACAO" | "FICHA_DE_EMERGENCIA" | "SHIPPERS_DECLARATION" | "ANEXO_VII" | "FICHA_DE_LOTE" | "CERTIFICADO_FITOSSANITARIO" | null;
